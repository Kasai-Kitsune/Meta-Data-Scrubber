...
Images (PNG, JPG/JPEG, WebP, HEIC/HEIF): visible pixels are decoded and redrawn onto a new image. HEIC/HEIF is converted to PNG (preserves transparency). Original metadata is not intentionally carried over.
Animated WebP is not supported and will be rejected.
